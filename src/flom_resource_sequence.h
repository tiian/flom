 ...
 */
#ifndef FLOM_RESOURCE_SEQUENCE_H
# define FLOM_RESOURCE_SEQUENCE_H
...
extern "C" {
    ...
    /**
     * Manage an incoming message for a "sequence" resource
     * @param resource IN/OUT reference to resource object
    ...
    /**
     * Destroy a sequence resource (frees holders list and waitings queue)
     * @param resource IN/OUT reference to resource object
     */
...
#endif /* FLOM_RESOURCE_SEQUENCE_H */
