...
public class FlomErrorCodes {
	...
	public final static int FLOM_RC_GETNAMEINFO_ERROR = -109;
	public final static int FLOM_RC_GETSOCKNAME_ERROR = -110;
	public final static int FLOM_RC_GETSOCKOPT_ERROR = -111;
	public final static int FLOM_RC_INET_NTOP_ERROR = -112;
	public final static int FLOM_RC_LISTEN_ERROR = -113;
	public final static int FLOM_RC_MALLOC_ERROR = -114;
	public final static int FLOM_RC_PIPE_ERROR = -115;
	public final static int FLOM_RC_POLL_ERROR = -116;
	public final static int FLOM_RC_READ_ERROR = -117;
	public final static int FLOM_RC_RECV_ERROR = -118;
	public final static int FLOM_RC_RECVFROM_ERROR = -119;
	public final static int FLOM_RC_REGCOMP_ERROR = -120;
	public final static int FLOM_RC_REGEXEC_ERROR = -121;
	public final static int FLOM_RC_SEND_ERROR = -122;
	public final static int FLOM_RC_SENDTO_ERROR = -123;
	public final static int FLOM_RC_SETSID_ERROR = -124;
	public final static int FLOM_RC_SETSOCKOPT_ERROR = -125;
	public final static int FLOM_RC_SIGACTION_ERROR = -126;
	public final static int FLOM_RC_SIGNAL_ERROR = -127;
	public final static int FLOM_RC_SOCKET_ERROR = -128;
	public final static int FLOM_RC_SNPRINTF_ERROR = -129;
	public final static int FLOM_RC_UNLINK_ERROR = -130;
	public final static int FLOM_RC_WAIT_ERROR = -131;
	public final static int FLOM_RC_WRITE_ERROR = -132;
