...
public class FlomErrorCodes {
	...
	public final static int FLOM_RC_REALPATH_ERROR = -119;
	public final static int FLOM_RC_RECV_ERROR = -120;
	public final static int FLOM_RC_RECVFROM_ERROR = -121;
	public final static int FLOM_RC_REGCOMP_ERROR = -122;
	public final static int FLOM_RC_REGEXEC_ERROR = -123;
	public final static int FLOM_RC_SEND_ERROR = -124;
	public final static int FLOM_RC_SENDTO_ERROR = -125;
	public final static int FLOM_RC_SETSID_ERROR = -126;
	public final static int FLOM_RC_SETSOCKOPT_ERROR = -127;
	public final static int FLOM_RC_SIGACTION_ERROR = -128;
	public final static int FLOM_RC_SIGNAL_ERROR = -129;
	public final static int FLOM_RC_SOCKET_ERROR = -130;
	public final static int FLOM_RC_SNPRINTF_ERROR = -131;
	public final static int FLOM_RC_UNLINK_ERROR = -132;
	public final static int FLOM_RC_WAIT_ERROR = -133;
	public final static int FLOM_RC_WRITE_ERROR = -134;
