...
public class FlomErrorCodes {
	...
	public final static int FLOM_RC_SIGNAL_ERROR = -133;
	public final static int FLOM_RC_SOCKET_ERROR = -134;
	public final static int FLOM_RC_SNPRINTF_ERROR = -135;
	public final static int FLOM_RC_UNLINK_ERROR = -136;
	public final static int FLOM_RC_WAIT_ERROR = -137;
	public final static int FLOM_RC_WRITE_ERROR = -138;
