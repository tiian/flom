...
public class FlomErrorCodes {
	...
	public final static int FLOM_RC_VFS_CONSISTENCY_ERROR = -28;
	public final static int FLOM_RC_OBJ_NOT_FOUND_ERROR = -29;
	...
	public final static int FLOM_RC_FLOCK_ERROR = -107;
	public final static int FLOM_RC_FORK_ERROR = -108;
	public final static int FLOM_RC_GETADDRINFO_ERROR = -109;
	public final static int FLOM_RC_GETIFADDRS_ERROR = -110;
	public final static int FLOM_RC_GETNAMEINFO_ERROR = -111;
	public final static int FLOM_RC_GETSOCKNAME_ERROR = -112;
	public final static int FLOM_RC_GETSOCKOPT_ERROR = -113;
	public final static int FLOM_RC_GETTIMEOFDAY_ERROR = -114;
	public final static int FLOM_RC_INET_NTOP_ERROR = -115;
	public final static int FLOM_RC_LISTEN_ERROR = -116;
	public final static int FLOM_RC_LOCALTIME_R_ERROR = -117;
	public final static int FLOM_RC_MALLOC_ERROR = -118;
	public final static int FLOM_RC_OPEN_ERROR = -119;
	public final static int FLOM_RC_PIPE_ERROR = -120;
	public final static int FLOM_RC_POLL_ERROR = -121;
	public final static int FLOM_RC_READ_ERROR = -122;
	public final static int FLOM_RC_REALPATH_ERROR = -123;
	public final static int FLOM_RC_RECV_ERROR = -124;
	public final static int FLOM_RC_RECVFROM_ERROR = -125;
	public final static int FLOM_RC_REGCOMP_ERROR = -126;
	public final static int FLOM_RC_REGEXEC_ERROR = -127;
	public final static int FLOM_RC_SEND_ERROR = -128;
	public final static int FLOM_RC_SENDTO_ERROR = -129;
	public final static int FLOM_RC_SETSID_ERROR = -130;
	public final static int FLOM_RC_SETSOCKOPT_ERROR = -131;
	public final static int FLOM_RC_SIGACTION_ERROR = -132;
	public final static int FLOM_RC_SIGADDSET_ERROR = -133;
	public final static int FLOM_RC_SIGEMPTYSET_ERROR = -134;
	public final static int FLOM_RC_SIGNAL_ERROR = -135;
	public final static int FLOM_RC_SIGPROCMASK_ERROR = -136;
	public final static int FLOM_RC_SOCKET_ERROR = -137;
	public final static int FLOM_RC_SNPRINTF_ERROR = -138;
	public final static int FLOM_RC_UNLINK_ERROR = -139;
	public final static int FLOM_RC_WAIT_ERROR = -140;
	public final static int FLOM_RC_WRITE_ERROR = -141;
	...
	public final static int FLOM_RC_G_NODE_NEW_ERROR = -207;
	public final static int FLOM_RC_G_NODE_PREPEND_DATA_ERROR = -208;
	public final static int FLOM_RC_G_PTR_ARRAY_REMOVE_INDEX_FAST_ERROR = -209;
	public final static int FLOM_RC_G_QUEUE_NEW_ERROR = -210;
	public final static int FLOM_RC_G_STRDUP_ERROR = -211;
	public final static int FLOM_RC_G_STRNDUP_ERROR = -212;
	public final static int FLOM_RC_G_STRSPLIT_ERROR = -213;
	public final static int FLOM_RC_G_THREAD_CREATE_ERROR = -214;
	public final static int FLOM_RC_G_TRY_MALLOC_ERROR = -215;
	public final static int FLOM_RC_G_TRY_REALLOC_ERROR = -216;
